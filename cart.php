...
<head>
    ...
    <style>
        ...
        @media only screen and (max-width: 600px) {
            #my_btn{width:100%;margin-top:5px; }
...
<div class="container-fluid main_div" id="hello" style="padding:20px;">
        ...
        if($total_pro<=0){
            ...
            while($cart_rec=mysqli_fetch_array($get_cart)){
                ...
                while($pro_rec=mysqli_fetch_array($get_pro)){
                    ...
                    $sub_total_price_for_single+=$p_price;
                        ...
                        <form action="cart_action.php" method="get">
                            <div class="well" style="height:170px;">
                                ...
                                <div style="width:80%;float:right;padding-left:5px;">
                                    ...
                                    <p style="color:#ff3b00;font-size:1.2em;display:inline"><span class='fa fa-rupee'>. </span><?=$sub_total_price_for_single;?></p>
                                ...
                                <div style="width:100%;padding-top:2px;text-align:center;" >
                                    ...
                                    <!--<a href="details.php?pro_id=<?=$p_id;?>">-->
                                        <button name="buynow" type="submit" class="btn btn-info btn-xs" style="margin-left:7px;margin-right:7px;">Buy Now</button>
                                    <!--</a>-->
    ...
    <?php
        ...
        while($cart_rec=mysqli_fetch_array($get_cart)){
            ...
            $pro_rec=mysqli_fetch_array(mysqli_query($con,"SELECT * FROM products WHERE product_id='$p_id'"));
    ...
    <div class="row">
        ...
        <div class="container">
            ...
            ?>
            <a href="checkout.php">
                <button id="my_btn" class="pull-right" style="background:#970149;color:#fff">PLACE ORDER</button>
            </a>
            <a href="index.php">
